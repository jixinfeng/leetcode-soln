...
class Logger(object):
    ...
    def shouldPrintMessage(self, timestamp, message):
        ...
        if message not in self.log:
            ...
            return True
        elif timestamp-10>=self.log[message]:
            self.log[message]=timestamp
            return True
        else:
            return False
...
import collections
a=Logger()
print(a.shouldPrintMessage(1,'foo'))
print(a.shouldPrintMessage(1,'bar'))
print(a.shouldPrintMessage(10,'foo'))
print(a.shouldPrintMessage(10,'bar'))
print(a.shouldPrintMessage(11,'foo'))
